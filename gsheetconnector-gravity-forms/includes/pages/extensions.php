    ...
    <div class="inner-wrap  w-100 bg-white p-40">
        ...
        <div class="gsc-about-wrapper animated-border">
            ...
            <div class="gsc-about-hero">
                ...
                <div class="gsc-about-hero-content">
                    ...
                    <div class="about-us-heading fw-500 mb-20 text-center">
                        <?php esc_html_e('About GSheetConnector', 'gsheetconnector-gravity-forms'); ?>
                    </div>
                    <div class="about-us-subheading fw-300 mb-20 text-center">
                        <?php esc_html_e('Built by Experts. Trusted by Thousands.', 'gsheetconnector-gravity-forms'); ?>
                    </div>
                    ...
                    <div class="gsc-connection-box flex-wrap gsc-founder-card mt-30 justify-between">
                        <div class="d-flex flex-wrap align-center gap-10 responsive-center">
                            <div>
                                <img src="<?php echo esc_url(GRAVITY_GOOGLESHEET_URL); ?>/assets/image/founder.webp" alt="Founder">
                            </div>
                    ...
                    <div class="heading mb-20 mt-20 text-center">
                        <?php esc_html_e('Meet Our Core Team', 'gsheetconnector-gravity-forms'); ?>
                    </div>
                    <!-- Team Avatars -->
            ...
            <div class=" gsc-about-content">
                ...
                <div class="gsc-about-text">
                    ...
                    <div class="heading mt-0">
                        <?php esc_html_e('Our Mission', 'gsheetconnector-gravity-forms'); ?>
                    </div>
                    ...
                    <ul class="gsc-about-list">
                        ...
                        <li><?php esc_html_e('Fast & Reliable Data Sync', 'gsheetconnector-gravity-forms'); ?></li>

                        <li><?php esc_html_e('100% Secure Authentication', 'gsheetconnector-gravity-forms'); ?></li>

                        <li><?php esc_html_e('Real-Time Google Sheets Updates', 'gsheetconnector-gravity-forms'); ?></li>

                        <li><?php esc_html_e('Easy Setup & Configuration', 'gsheetconnector-gravity-forms'); ?></li>

                        <li><?php esc_html_e('Dedicated Support Team', 'gsheetconnector-gravity-forms'); ?></li>
                ...
                <div class="gsc-about-stats">
                    ...
                    <div class="gsc-stat-card d-flex align-center justify-center bg-white text-white">
                        <div class="gsc-stat-card-header">
                            <span class="gravity-free-counter" data-count="11">0</span><span class="suffix">+</span>
                        </div>
                        <span><?php esc_html_e('Forms Successfully Synced', 'gsheetconnector-gravity-forms'); ?></span>
                    </div>

                    <div class="gsc-stat-card d-flex align-center justify-center bg-white text-white">
                        <div class="gsc-stat-card-header">
                            <span class="gravity-free-counter" data-count="50">0</span><span class="suffix">+</span>
                        </div>
                        <span><?php esc_html_e('Trusted by Active Users', 'gsheetconnector-gravity-forms'); ?></span>
                    </div>

                    <div class="gsc-stat-card d-flex align-center justify-center bg-white text-white">
                        <div class="gsc-stat-card-header">
                            <span class="gravity-free-counter" data-count="99.9">0</span><span class="suffix">%</span>
                        </div>
                        <span><?php esc_html_e('Reliable Uptime', 'gsheetconnector-gravity-forms'); ?></span>
                    </div>

                    <div class="gsc-stat-card d-flex align-center justify-center bg-white text-white">
                        <div class="gsc-stat-card-header">
                            <span class="gravity-free-counter" data-count="24">0</span><span class="suffix">/7</span>
                        </div>
                        <span><?php esc_html_e('Dedicated Support', 'gsheetconnector-gravity-forms'); ?></span>
                    </div>
            ...
            <div class="extensions-list">
                <div class="heading mt-40"><?php esc_html_e('Add-ons & Extensions', 'gsheetconnector-gravity-forms'); ?></div>
                ...
                $plugins = [
                    'contact-form-7/wp-contact-form-7.php' => [
                        ...
                        'name' => __('CF7 Google Sheet Connector', 'gsheetconnector-gravity-forms'),

                        'link' => 'https://www.gsheetconnector.com/cf7-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-cf7-gsc.webp',

                        'text' => __('Easily connect Contact Form 7 to Google Sheets and automatically sync form submissions in real-time. Every entry is instantly added to your selected spreadsheet, helping you manage leads, inquiries, and customer data efficiently without manual export.', 'gsheetconnector-gravity-forms'),
                        ...
                        'button' => __('Install', 'gsheetconnector-gravity-forms'),
                        'badge'  => __('PRO', 'gsheetconnector-gravity-forms'),
                    ...
                    'wpforms-lite/wpforms.php' => [
                        ...
                        'name' => __('WPForms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/wpforms-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-wpf-gsc.webp',
                        'text' => __('Integrate WPForms with Google Sheets and send form entries directly to your spreadsheet automatically. Track leads, manage customer data, and streamline reporting with seamless Google Sheets integration and real-time sync.', 'gsheetconnector-gravity-forms'),
                    ...
                    'gravityforms/gravityforms.php' => [
                        ...
                        'name' => __('Gravity Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/gravity-forms-google-sheet-connector',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-gravity-gsc.webp',
                        'text' => __('Connect Gravity Forms to Google Sheets and automatically push form submissions to your spreadsheet. Simplify data management, improve workflow automation, and keep all entries organized in one secure location.', 'gsheetconnector-gravity-forms'),
                    ...
                    'ninja-forms/ninja-forms.php' => [
                        ...
                        'name' => __('Ninja Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/ninja-forms-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-ninjaf-gsc.webp',
                        'text' => __('Automatically sync Ninja Forms submissions to Google Sheets with one-click integration. Capture leads, monitor responses, and manage data efficiently with instant spreadsheet updates and easy reporting.', 'gsheetconnector-gravity-forms'),
                    ...
                    'forminator/forminator.php' => [
                        ...
                        'name' => __('Forminator Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://wordpress.org/plugins/gsheetconnector-forminator/',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/forminator-addon.webp',
                        'text' => __('Integrate Forminator Forms with Google Sheets to automatically store form entries in your spreadsheet. Eliminate manual data entry and ensure accurate, real-time syncing for better data tracking and analysis.', 'gsheetconnector-gravity-forms'),
                        ...
                        'button' => __('Install', 'gsheetconnector-gravity-forms'),
                        'badge' => __('Free', 'gsheetconnector-gravity-forms'),
                    ...
                    'formidable/formidable.php' => [
                        ...
                        'name' => __('Formidable Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://wordpress.org/plugins/gsheetconnector-formidable-forms/',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/formidable-addon.webp',
                        'text' => __('Automatically sync Formidable Forms entries to Google Sheets. Manage leads, track submissions, and simplify data reporting with real-time integration.', 'gsheetconnector-gravity-forms'),
                        'pro_plugin_active' => 'gsheetconnector-forminator-pro/gsheetconnector-forminator-pro.php',
                    ...
                    'fluentform/fluentform.php' => [
                        'connector' => 'gsheetconnector-for-fluentform/gsheetconnector-for-fluentform.php',
                        'connector-pro' => 'gsheetconnector-for-fluentform-pro/gsheetconnector-for-fluentform-pro.php',
                        'name' => __('Fluent Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/fluent-forms-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-fluent-forms-gsc.webp',
                        'text' => __('Automatically sync Fluent Forms submissions to Google Sheets in real-time. Every form entry is instantly added to your selected spreadsheet, helping you manage leads, customer inquiries, and business data without manual export. Streamline your workflow, improve reporting accuracy, and keep all submissions organized with seamless Google Sheets integration.', 'gsheetconnector-gravity-forms'),
                        'pro_plugin_active' => 'gsheetconnector-for-fluentform-pro/gsheetconnector-for-fluentform-pro.php',
                        'url' => 'https://wordpress.org/plugins/gsheetconnector-for-fluentform/',
                        'button' => __('Install', 'gsheetconnector-gravity-forms'),
                        'badge' => __('Free', 'gsheetconnector-gravity-forms'),
                        'freeLink' => 'https://wordpress.org/plugins/gsheetconnector-for-fluentform/',
                        'downloadLink' => '"https://downloads.wordpress.org/plugin/gsheetconnector-for-fluentform.1.0.8.zip"',
                    ...
                    'pro-elements/pro-elements.php' => [
                        ...
                        'name' => __('Elementor Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/elementor-forms-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-elemntor-gsc.webp',
                        'text' => __('Sync Elementor Forms with Google Sheets instantly. Automatically add new form submissions to your spreadsheet, manage leads efficiently, and simplify reporting with real-time data synchronization.', 'gsheetconnector-gravity-forms'),
                    ...
                    'avada/avada.php' => [
                        'connector' => '',
                        'connector-pro' => 'avada-gsheetconnector-pro/avada-gsheetconnector-pro.php',
                        'name' => __('Avada Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/avada-forms-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-avada-gsc.webp',
                        'text' => __('Connect Avada Forms to Google Sheets and automatically transfer form entries to your spreadsheet. Streamline lead management, automate data collection, and improve business reporting with seamless integration.', 'gsheetconnector-gravity-forms'),
                        'pro_plugin_active' => 'avada-gsheetconnector-pro/avada-gsheetconnector-pro.php',
                        'url' => '',
                        'button' => __('Install', 'gsheetconnector-gravity-forms'),
                        'badge' => __('Available PRO Version', 'gsheetconnector-gravity-forms'),
                        'freeLink' => '',
                        'downloadLink' => '',
                        'buyLink' => 'https://www.gsheetconnector.com/avada-forms-google-sheet-connector-pro',
                        'mainPlugin' => ['fusion-core/fusion-core.php', 'fusion-builder/fusion-builder.php'],
                        'theme' => 'Avada',
                    ...
                    'divi/divi.php' => [
                        ...
                        'name' => __('Divi Forms Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/divi-forms-db-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-divi-gsc.webp',
                        'text' => __('Integrate Divi Forms with Google Sheets and automatically sync submissions in real-time. Store customer data securely, track inquiries efficiently, and eliminate manual spreadsheet updates.', 'gsheetconnector-gravity-forms'),
                    ...
                    'gsheetconnector-for-wp-core/gsheetconnector-for-wp-core.php' => [
                        ...
                        'name' => __('WP Core Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/gsheetconnector-for-wp-core',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/gsc-wp-core.webp',
                        'text' => __('Automatically send WordPress core data (like comments or custom submissions) to Google Sheets. Simplify website data tracking, automate record keeping, and centralize important information in one organized spreadsheet.', 'gsheetconnector-gravity-forms'),
                    ...
                    'woocommerce/woocommerce.php' => [
                        ...
                        'text' => __('Sync WooCommerce orders with Google Sheets automatically. Store order details, customer information, and transaction data in real-time for easy reporting, accounting, and business analysis.', 'gsheetconnector-gravity-forms'),
                    ...
                    'easy-digital-downloads/easy-digital-downloads.php' => [
                        'connector' => 'gsheetconnector-easy-digital-downloads/gsheetconnector-easy-digital-downloads.php',
                        'connector-pro' => 'gsheetconnector-easy-digital-downloads-pro/gsheetconnector-easy-digital-downloads-pro.php',
                        'name' => __('Easy Digital Downloads Google Sheet Connector', 'gsheetconnector-gravity-forms'),
                        'link' => 'https://www.gsheetconnector.com/easy-digital-downloads-google-sheet-connector-pro',
                        'img' => esc_url(GRAVITY_GOOGLESHEET_URL) . '/assets/image/pro-edd-gsc.webp',
                        'text' => __('Automatically send Easy Digital Downloads (EDD) order details to Google Sheets. Track digital product sales, monitor transactions, and manage customer data effortlessly with real-time spreadsheet integration.', 'gsheetconnector-gravity-forms'),
                        'pro_plugin_active' => 'gsheetconnector-easy-digital-downloads-pro/gsheetconnector-easy-digital-downloads-pro.php',
                        'url' => 'https://wordpress.org/plugins/gsheetconnector-easy-digital-downloads/',
                        'button' => __('Install', 'gsheetconnector-gravity-forms'),
                        'badge' => __('PRO', 'gsheetconnector-gravity-forms'),
                ...
                <div class="gsc-market-header">
                    <div class="extensions-sub-heading"><?php echo esc_html(__('Installed & Active Plugins', 'gsheetconnector-gravity-forms')); ?></div>
                    <div>
                        <p><?php echo esc_html(__('View and manage all currently installed and active connectors on your site. You can activate, deactivate, or upgrade plugins from here.', 'gsheetconnector-gravity-forms')); ?>
                        </p>
                    </div>
                </div>
                                    ...
                                    <div class="extension-bg-color-set">
                                        <div class="gsc-ext-top">
                                            ...
                                            <div class="plugin-premium gsc-ext-badge pro-badge">
                                                <?php esc_html_e('Pro', 'gsheetconnector-gravity-forms'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="addon-item-header-meta">
                                        ...
                                        <div class="activated gsc-ext-actions">
                                            ...
                                            <a href="<?php echo esc_url($details['docs']); ?>"
                                                ...
                                                <?php esc_attr_e('View Docs', 'gsheetconnector-gravity-forms'); ?>

                                            </a>

                                            <a
                                                class="btn deactivate-btn gscgff-deactivate-plugin"
                                                data-download="<?php echo esc_attr($details['connector-pro']); ?>"
                                                data-plugin="<?php echo esc_attr($details['connector-pro']); ?>">

                                                <?php esc_html_e('Deactivate', 'gsheetconnector-gravity-forms'); ?>
                                    ...
                                    <div class="extension-bg-color-set">
                                        <div class="gsc-ext-top">
                                            ...
                                            <div class="plugin-free gsc-ext-badge free-green">
                                                <?php esc_html_e('Free', 'gsheetconnector-gravity-forms'); ?>
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- Second section -->
                <div class="gsc-market-header">
                    <div class="extensions-sub-heading"><?php echo esc_html(__('Recommended Plugins', 'gsheetconnector-gravity-forms')); ?></div>
                    <div>
                        <p><?php echo esc_html(__('Discover recommended plugins that enhance your workflow and help you get more value from your Google Sheets integration.', 'gsheetconnector-gravity-forms')); ?>
                        </p>
                    </div>
                </div>
                <div class="gsheetconnector-addons-list gsc-ext-grid">
                        ...
                        <?php if ($is_theme_match): ?>
                            <div class="gsheetconnector-list-item gsc-ext-card">
                                <div class="addon-item-header">
                                    ...
                                    <div class="addon-item-header-meta">
                                        <div class="plugin-premium gsc-ext-badge pro-badge">
                                            <?php echo esc_html(__('Pro', 'gsheetconnector-gravity-forms')); ?>
                                        </div>
                                        <div class="addon-item-meta-title">
                                ...
                                <div class="addon-item-header">
                                    <div class="extension-bg-color-set">
                                        <div class="gsc-ext-top">
                                            ...
                                            <?php else: ?>
                                                <div class="plugin-free gsc-ext-badge free-green">
                                                    <?php echo esc_html(__('Free', 'gsheetconnector-gravity-forms')); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="addon-item-footer">
                                            <div class="button-bar gsc-ext-actions">
                                                <a href="<?php echo esc_url($data['docs']); ?>" target="_blank"
                                                    class="btn btn-default link-hover-white"><?php echo esc_html(__('View Docs', 'gsheetconnector-gravity-forms')); ?>
                                                </a>
                                                <?php if ($is_pro_installed && !$is_pro_active): ?>
                                                    <button class="gscgff-activate-plugin-btn btn activate button-pro"
                                                        data-plugin="<?php echo esc_attr($data['pro_plugin_active']); ?>">
                                                        <?php esc_html_e('Activate', 'gsheetconnector-gravity-forms'); ?>
                                                    </button>
                                                    <span class="loading-sign-active mt-25"></span>
                                                <?php elseif ($is_free_installed && !$is_free_active): ?>
                                                    <button class="gscgff-activate-plugin-btn btn activate button-free"
                                                        data-plugin="<?php echo esc_attr($data['connector']); ?>">
                                                        <?php esc_html_e('Activate', 'gsheetconnector-gravity-forms'); ?>
                                                    </button>
                                                    <span class="loading-sign-active mt-25"></span>
                                                <?php else: ?>
                                                    <button class="gscgff-install-plugin-btn btn btn-default"
                ...
                <div class="gsc-marketplace">
                    ...
                    <div class="gsc-market-header">
                        <div>
                            <div class="extensions-sub-heading"><?php echo esc_html(__('Explore More Plugins', 'gsheetconnector-gravity-forms')); ?></div>
                            <div>
                                <p class="mt-15 mb-0"><?php echo esc_html(__('Discover the right connector for your workflow and automate data syncing.', 'gsheetconnector-gravity-forms')); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="gsc-market-tabs d-flex flex-wrap gap-10 pt-15 pb-15 pl-15 pr-15">
                            ...
                            <button class="market-tab active fw-600" data-filter="all"><?php echo esc_html(__('All', 'gsheetconnector-gravity-forms')); ?></button>
                            <button class="market-tab fw-600" data-filter="forms"><?php echo esc_html(__('Forms', 'gsheetconnector-gravity-forms')); ?></button>
                            <button class="market-tab fw-600" data-filter="builders"><?php echo esc_html(__('Page Builders', 'gsheetconnector-gravity-forms')); ?></button>
                            <button class="market-tab fw-600" data-filter="shop"><?php echo esc_html(__('eCommerce', 'gsheetconnector-gravity-forms')); ?></button>
                                ...
                                <div class="gsc-ext-top">
                                    <div class="extension-bg-color-set">
                                        ...
                                        <?php if (!empty($data['freeLink'])): ?>
                                            <span class="plugin-free gsc-ext-badge free-green"><?php echo esc_html(__('Free', 'gsheetconnector-gravity-forms')); ?></span>

                                        <?php else: ?>
                                            <span class="plugin-premium gsc-ext-badge pro-badge"><?php echo esc_html(__('Pro', 'gsheetconnector-gravity-forms')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                        ...
                                        <div class="button-bar gsc-ext-actions">
                                            ...
                                            <?php if (!empty($data['demo'])): ?>
                                                ...
                                                <a href="<?php echo esc_url($data['demo']); ?>" target="_blank"
                                                    class="btn buy text-decoration-none"><?php echo esc_html(__('View Demo', 'gsheetconnector-gravity-forms')); ?>
                                                </a>
                ...
                <!--NEW-->
                <?php wp_nonce_field('gscgff-ajax-nonce', 'gscgff-ajax-nonce'); ?>
            </div>
            <!--popup start-->
            <div id="gscgff-confirm-dective-popup-free" class="gscgff-popup-overlay d-none">
                <div class="gscgff-popup  text-center">
                    ...
                    <div class="gsc-modal-title"><?php echo esc_html__('Deactivate plugin', 'gsheetconnector-gravity-forms'); ?></div>
                    <p class="gsc-modal-text"><?php echo esc_html__(' Are you sure you want to deactivate this plugin?', 'gsheetconnector-gravity-forms'); ?>
                    </p>
                    <div class="popup-actions d-flex justify-center gap-10">
                        <button type="button" class="btn deactivate-btn" id="gscgff-dective-popup-cancel-free">
                            <?php echo esc_html__('Cancel', 'gsheetconnector-gravity-forms'); ?>
                        </button>
                        <button type="button" class="btn btn-primary" id="gscgff-deactive-popup-confirm-free">
                            <?php echo esc_html__('Deactivate', 'gsheetconnector-gravity-forms'); ?>
                        </button>
                    </div>
                </div>
            </div>
            <div id="gscgff-confirm-active-popup-free" class="gscgff-popup-overlay d-none">
                <div class="gscgff-popup text-center">
