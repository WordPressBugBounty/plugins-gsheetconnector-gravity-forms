...
<form id="gsc_gravityform_settings_form" method="post" action="options.php">
    ...
    <div class="gsc-pro-promo ml-15 mr-pro-15">
        ...
        <div>
            ...
            <span
            class="gsc-pro-badge"><?php echo esc_html(__('FREE users get special upgrade pricing', 'gsheetconnector-gravity-forms')); ?></span>
        </div>
    </div>
...
<div class="gscgff-role-settings" id="gsc-googlesheet">
    <div class="wrap w-100 m-0">
        <div class="inner-wrap w-100 bg-white p-40 blur-pro-feature">
            <div class="heading mt-0"><?php echo esc_html__('Access Control', 'gsheetconnector-gravity-forms'); ?>
        </div>
    ...
    <div class="gscgff_gravityform-card">
        ...
        <div class='para-heading fw-600 mb-20'>" . esc_html__('Allowed Roles', 'gsheetconnector-gravity-forms') . "</div>";
            ...
            if ($role === "administrator") {
                ...
                <div class="gsc-access-info">
                    <div class="para-heading fw-600 mb-20">
                        ...
                        <ul>
                            <li><?php echo esc_html__('Grant access only to users you trust', 'gsheetconnector-gravity-forms'); ?>Grant
                            access only to users you trust</li>
                            <li><?php echo esc_html__('Editors can manage and modify integrations', 'gsheetconnector-gravity-forms'); ?>
                        </li>
                        <li><?php echo esc_html__('Review role permissions on a regular basis', 'gsheetconnector-gravity-forms'); ?>
                    </li>
                    <li><?php echo esc_html__('Do not allow access to subscribers', 'gsheetconnector-gravity-forms'); ?>
                </li>
            </ul>
        </div>
    </div>
