...
<div class="system-statuswc">
    <div class="info-container">
        ...
        <button onclick="copySystemInfo()"
            class="copy"><?php echo __("Copy System Info to Clipboard", "gsheetconnector-gravityforms"); ?></button>
...
<div class="system-Error">
    <div class="error-container">
        ...
        <button onclick="copyErrorLog()"
            class="copy"><?php echo __("Copy Error Log to Clipboard", "gsheetconnector-gravityforms"); ?></button>
        ...
        <input type="hidden" name="gf-ajax-nonce" id="gf-ajax-nonce"
            value="<?php echo wp_create_nonce('gf-ajax-nonce'); ?>" />
        <!-- <button onclick="clearErrorLog()" class="clearlogs">Clear</button>  -->
        <div class="copy-message" style="display: none;"><?php echo __("Copied", "gsheetconnector-gravityforms"); ?>
