    ...
    <div class="inner-wrap  w-100 bg-white p-40">
        <div class="gsc-dashboard">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="dashboard-left-wrapper mr-15">
                        ...
                        <div class="welcome-wrapper mb-30">
                            <div class="welcome-content">
                                <div class="welcome-heading mb-20">
                                    <span><?php echo esc_html__('Welcome To GSheetConnector', 'gsheetconnector-gravity-forms'); ?></span>
                                </div>
                                <p>
                        ...
                        <div class="set-up-guid-wrapper welcome-wrapper">
                            <div class="welcome-content">
                                <div class="welcome-heading mb-20">
                                    <span><?php echo esc_html__('Setup Guide & Troubleshooting', 'gsheetconnector-gravity-forms'); ?></span>
                                </div>
                                <p>
                                    <?php echo esc_html__('Sync Gravity Forms data with Google Sheets in real-time effortlessly and accurately.', 'gsheetconnector-gravity-forms'); ?>
                                </p>
                            </div>
                            ...
                            <div class="setup-content-data mt-20">
                                <div class="setup-row d-flex justify-between gap-20">
                                    <div class="google-api-setting-guide">
                                        <div class="dashboard-pro-small-head"><?php echo esc_html__('Getting Started', 'gsheetconnector-gravity-forms'); ?></div>
                                        <ul>
                                            <li><a href="https://www.gsheetconnector.com/docs/gravity-forms-gsheetconnector/installation-process-free-version" target="_blank"><?php echo esc_html__('Installation Process', 'gsheetconnector-gravity-forms'); ?></a></li>
                                            <li><a href="https://www.gsheetconnector.com/docs/gravity-forms-gsheetconnector/integration-with-google-existing-method" target="_blank"><?php echo esc_html__('Integration with Google (Existing Method)', 'gsheetconnector-gravity-forms'); ?></a></li>
                                            <li><a href="https://www.gsheetconnector.com/docs/gravity-forms-gsheetconnector/plugin-settings-free-version#toc-heading-0" target="_blank"><?php echo esc_html__('Integration of Gravity Forms with Google Sheet', 'gsheetconnector-gravity-forms'); ?></a></li>
                                        </ul>
                                    </div>
                                    <div class="google-api-setting-guide">
                                        <div class="dashboard-pro-small-head"><?php echo esc_html__('Docs & Troubleshooting', 'gsheetconnector-gravity-forms'); ?></div>
                                        <ul>
                                            <li><a href=" https://www.gsheetconnector.com/docs/general/how-to-enable-debugging-in-wordpress" target="_blank"><?php echo esc_html__('How to Enable Debugging in WordPress', 'gsheetconnector-gravity-forms'); ?></a></li>
                                            <li><a href="https://www.gsheetconnector.com/docs/general/common-errors-issues#toc-heading-1" target="_blank"><?php echo esc_html__('Invalid OAuth2 token', 'gsheetconnector-gravity-forms'); ?></a></li>
                                            <li><a href="https://www.gsheetconnector.com/docs/general/how-to-change-date-time-format-and-time-zone-in-google-sheets" target="_blank"><?php echo esc_html__('Change Date/Time Format and Time Zone in Google Sheets', 'gsheetconnector-gravity-forms'); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="setup-row">
                                    <div class="google-api-setting-guide">
                                        <div class="dashboard-pro-small-head"><?php echo esc_html__('Additional Resources', 'gsheetconnector-gravity-forms'); ?></div>
                                        <ul>
                ...
                <div class="col-6">
                    <div class="plugin-category-wrapper welcome-wrapper ml-15">
                        <div class="welcome-heading mb-20">
                            <span><?php echo esc_html__('Plugins by Category', 'gsheetconnector-gravity-forms'); ?></span>
                        </div>
                        <p>
                            <?php echo esc_html__('Find the perfect connector for your WordPress workflow.', 'gsheetconnector-gravity-forms'); ?>
                        </p>
                        <div class="plugin-category-section">
                            <a href="https://www.gsheetconnector.com/plugins#contactform" target="_blank" class="plugin-category-box text-decoration-none">
                                ...
                                <div class="plugin-category-content">
                                    <div class="plugin-category-name fw-600">
                                        <?php echo esc_html__('Contact Form Connectors', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                    <div class="plugin-category-badge">
                                        <?php echo esc_html__('6 plugins available', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                </div>
                            ...
                            <a href="https://www.gsheetconnector.com/plugins#ecommerce" target="_blank" class="plugin-category-box text-decoration-none">
                                ...
                                <div class="plugin-category-content">
                                    <div class="plugin-category-name fw-600">
                                        <?php echo esc_html__('eCommerce Connectors', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                    <div class="plugin-category-badge">
                                        <?php echo esc_html__('2 plugins available', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                </div>
                                <div class="plugin-category-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-slate-400 group-hover:text-emerald-600 group-hover:translate-x-0.5 transition-all" aria-hidden="true">
                            ...
                            <a href="https://www.gsheetconnector.com/plugins#pagebuilderform" target="_blank" class="plugin-category-box text-decoration-none">
                                ...
                                <div class="plugin-category-content">
                                    <div class="plugin-category-name fw-600">
                                        <?php echo esc_html__('Page Builder Forms', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                    <div class="plugin-category-badge">
                                        <?php echo esc_html__('3 plugins available', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                </div>
                                <div class="plugin-category-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-slate-400 group-hover:text-emerald-600 group-hover:translate-x-0.5 transition-all" aria-hidden="true">
                            ...
                            <a href="https://www.gsheetconnector.com/gsheetconnector-for-wp-core" class="plugin-category-box text-decoration-none" target="_blank">
                                ...
                                <div class="plugin-category-content">
                                    <div class="plugin-category-name fw-600">
                                        <?php echo esc_html__('WP Core Connector', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                    <div class="plugin-category-badge">
                                        <?php echo esc_html__('1 plugin available', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                </div>
                                <div class="plugin-category-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-slate-400 group-hover:text-emerald-600 group-hover:translate-x-0.5 transition-all" aria-hidden="true">
                            ...
                            <a href="https://profiles.wordpress.org/gsheetconnector/" class="plugin-category-box text-decoration-none" target="_blank">
                                ...
                                <div class="plugin-category-content">
                                    <div class="plugin-category-name fw-600">
                                        <?php echo esc_html__('Free Plugins', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                    <div class="plugin-category-badge">
                                        <?php echo esc_html__('12 plugin available', 'gsheetconnector-gravity-forms'); ?>
                                    </div>
                                </div>
                                <div class="plugin-category-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-slate-400 group-hover:text-emerald-600 group-hover:translate-x-0.5 transition-all" aria-hidden="true">
            ...
            <div class="pro-container mt-30 welcome-wrapper">
                <span class="pro-badge"><?php echo esc_html(__('Amazing Key Features', 'gsheetconnector-gravity-forms')); ?></span>
                <div class="welcome-heading mb-15 mt-20"><?php echo esc_html(__('Everything You Need to Sync Data', 'gsheetconnector-gravity-forms')); ?></div>
                <p>
                    <?php echo esc_html(__('Common features shared across every GSheetConnector Pro add-on built for reliability, flexibility, and scale.', 'gsheetconnector-gravity-forms')); ?>
                </p>
                ...
                <div class="d-flex gap-30 mt-30 d-flex-responsiveness">
                    <div class="pro-left w-50">
                        ...
                        <div class="pro-actions mt-30 gap-20">
                            ...
                            <a href="https://www.gsheetconnector.com/gravity-forms-google-sheet-connector#features" target="_blank"><?php echo esc_html(__('View Full Features', 'gsheetconnector-gravity-forms')); ?></a>
                        </div>
                    ...
                    <div class="pro-right w-50">
                        ...
                        <div class="right-card">
                            ...
                            <!-- FLOW -->
                            <div class="flow-ui">
                                <div class="flow-step"><?php echo esc_html(__('Form', 'gsheetconnector-gravity-forms')); ?></div>
                                <div class="line"></div>
                                <div class="flow-step mid"><?php echo esc_html(__('Processing', 'gsheetconnector-gravity-forms')); ?></div>
                                <div class="line"></div>
                                <div class="flow-step success"><?php echo esc_html(__('Sheet', 'gsheetconnector-gravity-forms')); ?></div>
                            </div>

                            <!-- STATS -->
                            <div class="sync-stats">
                                <div>
                                    <strong><?php echo esc_html(__('Instant', 'gsheetconnector-gravity-forms')); ?></strong>
                                    <p><?php echo esc_html(__('Real-time updates', 'gsheetconnector-gravity-forms')); ?></p>
                                </div>
                                <div>
                                    <strong><?php echo esc_html(__('100%', 'gsheetconnector-gravity-forms')); ?></strong>
                                    <p><?php echo esc_html(__('Accuracy', 'gsheetconnector-gravity-forms')); ?></p>
                                </div>
                                <div>
                                    <strong><?php echo esc_html(__('Flexible', 'gsheetconnector-gravity-forms')); ?></strong>
                                    <p><?php echo esc_html(__('Custom mapping', 'gsheetconnector-gravity-forms')); ?></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="video-section-wrapper mt-30 welcome-wrapper">
                <div class="welcome-heading mb-30">
                    <span><?php echo esc_html__('Video Tutorials', 'gsheetconnector-gravity-forms'); ?></span>
                </div>
