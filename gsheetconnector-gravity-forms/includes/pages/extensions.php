            ...
            <div class="gsc-about-hero">
              ...
              <div class="gsc-connection-box flex-wrap gsc-founder-card mt-30 justify-between">
                <div class="d-flex flex-wrap align-center gap-10 responsive-center">
                    <div>
                        <img src="<?php echo esc_url(GRAVITY_GOOGLESHEET_URL); ?>/assets/image/founder.webp"
                        alt="Founder">
                    </div>
    ...
    <div class=" gsc-about-content">
        ...
        <div class="gsc-about-text">
          ...
          <ul class="gsc-about-list">
            ...
            <li><?php esc_html_e('Real-Time Google Sheets Updates', 'gsheetconnector-gravity-forms'); ?>
        </li>
...
<div class="extensions-list">
    <div class="heading mt-40"><?php esc_html_e('Add-ons & Extensions', 'gsheetconnector-gravity-forms'); ?>
</div>
<p><?php echo esc_html__('Extend your Google Sheets integration with powerful add-ons. Install, manage, and activate extensions to unlock advanced features.', 'gsheetconnector-gravity-forms'); ?>
</p>
...
$plugins = [
  'contact-form-7/wp-contact-form-7.php' => [
    ...
    'name' => __('Google Sheet Connector For CF7', 'gsheetconnector-gravity-forms'),
...
'wpforms-lite/wpforms.php' => [
    ...
    'name' => __('Google Sheet Connector For WPForms', 'gsheetconnector-gravity-forms'),
...
'gravityforms/gravityforms.php' => [
    ...
    'name' => __('Google Sheet Connector For Gravity Forms', 'gsheetconnector-gravity-forms'),
...
'ninja-forms/ninja-forms.php' => [
    ...
    'name' => __('Google Sheet Connector For Ninja Forms', 'gsheetconnector-gravity-forms'),
...
'forminator/forminator.php' => [
    ...
    'name' => __('Google Sheet Connector For Forminator Forms', 'gsheetconnector-gravity-forms'),
...
'formidable/formidable.php' => [
    ...
    'name' => __('Google Sheet Connector For Formidable Forms', 'gsheetconnector-gravity-forms'),
...
'fluentform/fluentform.php' => [
    ...
    'connector-pro' => 'gsheetconnector-gravity-forms/gsheetconnector-gravity-forms.php',
    'name' => __('Google Sheet Connector For Fluent Forms', 'gsheetconnector-gravity-forms'),
    ...
    'pro_plugin_active' => 'gsheetconnector-gravity-forms/gsheetconnector-gravity-forms.php',
...
'pro-elements/pro-elements.php' => [
    ...
    'name' => __('Google Sheet Connector For Elementor Forms', 'gsheetconnector-gravity-forms'),
...
'avada/avada.php' => [
    ...
    'name' => __('Google Sheet Connector For Avada Forms', 'gsheetconnector-gravity-forms'),
...
'divi/divi.php' => [
    ...
    'name' => __('Google Sheet Connector For Divi Forms', 'gsheetconnector-gravity-forms'),
...
'gsheetconnector-for-wp-core/gsheetconnector-for-wp-core.php' => [
    ...
    'name' => __('GSheetConnector for WP Core', 'gsheetconnector-gravity-forms'),
...
'woocommerce/woocommerce.php' => [
    ...
    'name' => __('Google Sheet Connector For WooCommerce', 'gsheetconnector-gravity-forms'),
...
'easy-digital-downloads/easy-digital-downloads.php' => [
    'connector' => 'gsheetconnector-easy-digital-downloads/gsheetconnector-easy-digital-downloads.php',
    'connector-pro' => 'gsheetconnector-easy-digital-downloads-pro/gsheetconnector-easy-digital-downloads-pro.php',
    'name' => __('Google Sheet Connector For Easy Digital Downloads', 'gsheetconnector-gravity-forms'),
...
<div class="gsc-market-header">
    <div class="extensions-sub-heading">
        <?php echo esc_html(__('Installed & Active Plugins', 'gsheetconnector-gravity-forms')); ?></div>
        <div>
                ...
                <div class="gsheetconnector-list-item gsc-ext-card">
                    <div class="addon-item-header">
                        <div class="plugin-premium gsc-ext-badge pro-badge">
                            <?php echo esc_html(__('Pro', 'gsheetconnector-gravity-forms')); ?></div>
                            ...
                            <div class="addon-item-header-meta">
                                <div class="addon-item-meta-title">
                                    <a href="<?php echo esc_url($details['buyLink']); ?>" target="_blank"
                                        class="addon-link">
                                        <?php echo esc_html(__($details['name'], 'gsheetconnector-gravity-forms')); ?>
                                    </a>
                                </div>
                                <div class="addon-item-header-meta-excerpt">

                                    <?php echo esc_html(__($details['text'], 'gsheetconnector-gravity-forms')); ?>
                        ...
                        <div class="addon-item-footer">
                            <div class="button-bar gsc-ext-actions">
                                <a href="<?php echo esc_url($details['demo']); ?>" target="_blank"
                                    class="addon-link btn btn-default link-hover-white">
                                    <?php esc_attr_e('View Demo', 'gsheetconnector-gravity-forms'); ?>
                                </a>
                                <button class="gscgff-activate-plugin-btn btn activate button-free proactive"
                    ...
                    <div class="addon-item-header">
                        <div class="gsc-ext-top">
                            ...
                            <div class="plugin-free gsc-ext-badge free-green">
                                <?php echo esc_html(__('Free', 'gsheetconnector-gravity-forms')); ?></div>
                            </div>
                            <div class="addon-item-header-meta">
                                <div class="addon-item-meta-title">
                                    <a href="<?php echo esc_url($details['buyLink']); ?>" target="_blank"
                            ...
                            <div class="activated gsc-ext-actions">
                                ...
                                <a href="javascript:void(0);" class="btn deactivate-btn gscgff-deactivate-plugin"
                                data-download="<?php echo esc_url($details['connector']); ?>"
                                data-plugin="<?php echo esc_attr($details['connector']); ?>"><?php echo esc_html(__('Deactivate', 'gsheetconnector-gravity-forms')); ?></a>
                                <span class="loading-sign-deactive mt-25"></span>
                            </div>
                        </div>
                    </div>
                <?php }
            ...
            <div class="gsheetconnector-list-item gsc-ext-card">
                ...
                <div class="addon-item-header">
                    ...
                    <div class="activated gsc-ext-actions">
                        ...
                        data-plugin="<?php echo esc_attr($details['connector-pro']); ?>"><?php echo esc_html(__('Deactivate', 'gsheetconnector-gravity-forms')); ?></a>
                        <span class="loading-sign-deactive mt-25"></span>
                    </div>
                </div>
            <?php }
...
<div class="gsc-market-header">
    <div class="extensions-sub-heading">
        <?php echo esc_html(__('Recommended Plugins', 'gsheetconnector-gravity-forms')); ?></div>
        <div>
                ...
                <div class="addon-item-header">
                    <div class="gsc-ext-top">
                        <a href="<?php echo esc_url($data['url']); ?>" target="_blank">
                            ...
                            alt="<?php echo esc_attr($data['name']); ?>" class="gsc-ext-icon">
                        </a>
                        <div class="plugin-free gsc-ext-badge free-green">
                            <?php echo esc_html(__('Free', 'gsheetconnector-gravity-forms')); ?></div>
                        </div>
                        <div class="addon-item-header-meta">
                            <div class="addon-item-meta-title">
                                <a href="<?php echo esc_url($data['url']); ?>" target="_blank" class="addon-link">
                                    <?php echo esc_html(__($data['name'], 'gsheetconnector-gravity-forms')); ?>
                                </a>
                            </div>
                            <div class="addon-item-header-meta-excerpt">
                                <?php echo esc_html(__($data['text'], 'gsheetconnector-gravity-forms')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="addon-item-footer">
...
<div class="gsc-marketplace">
    ...
    <div class="gsc-market-header">
        <div>
            <div class="extensions-sub-heading">
                <?php echo esc_html(__('Explore More Plugins', 'gsheetconnector-gravity-forms')); ?>
            </div>
            <div>
                <p class="mt-15 mb-0">
                    <?php echo esc_html(__('Discover the right connector for your workflow and automate data syncing.', 'gsheetconnector-gravity-forms')); ?>
                </p>
            </div>
        </div>
        ...
        <div class="gsc-market-tabs d-flex flex-wrap gap-10 pt-15 pb-15 pl-15 pr-15">
            ...
            <button class="market-tab active fw-600"
            data-filter="all"><?php echo esc_html(__('All', 'gsheetconnector-gravity-forms')); ?></button>
            <button class="market-tab fw-600"
            data-filter="forms"><?php echo esc_html(__('Forms', 'gsheetconnector-gravity-forms')); ?></button>
            <button class="market-tab fw-600"
            data-filter="builders"><?php echo esc_html(__('Page Builders', 'gsheetconnector-gravity-forms')); ?></button>
            <button class="market-tab fw-600"
            data-filter="shop"><?php echo esc_html(__('eCommerce', 'gsheetconnector-gravity-forms')); ?></button>
  ...
  && isset($all_plugins[$data['pro_plugin_active']]);
            ...
            <div
            class="gsheetconnector-list-item gsc-ext-card gsc-market-item <?php echo esc_attr($category); ?>">
            ...
            <div class="gsc-ext-top">
                ...
                <?php if (!empty($data['freeLink'])): ?>
                    <span
                    class="plugin-free gsc-ext-badge free-green"><?php echo esc_html(__('Free', 'gsheetconnector-gravity-forms')); ?></span>
                    <?php else: ?>
                        <span
                        class="plugin-premium gsc-ext-badge pro-badge"><?php echo esc_html(__('Pro', 'gsheetconnector-gravity-forms')); ?></span>
                    ...
                    <div class="addon-item-footer">
                        <div class="button-bar gsc-ext-actions">
                                        ...
                                        <a href="<?php echo esc_url($data['docs']); ?>" target="_blank"
                                            ...
                                            <?php echo esc_html(__('View Docs', 'gsheetconnector-gravity-forms')); ?>
                                        </a>
                                        <?php //endif; 
                                        ?>
                                        ...
                                        <?php if (!empty($data['demo'])): ?>
                                            <a href="<?php echo esc_url($data['demo']); ?>" target="_blank"
                                                ...
                                                <?php echo esc_html(__('View Demo', 'gsheetconnector-gravity-forms')); ?>
                                            </a>
                                        <?php endif; ?>
        ...
        <div class="gsc-modal-title">
            <?php echo esc_html__('Deactivate plugin', 'gsheetconnector-gravity-forms'); ?></div>
            <p class="gsc-modal-text">
                <?php echo esc_html__(' Are you sure you want to deactivate this plugin?', 'gsheetconnector-gravity-forms'); ?>
            </p>
            <div class="popup-actions d-flex justify-center gap-10">
                <button type="button" class="btn btn-deactivate" id="gscgff-dective-popup-cancel-free">
    ...
    <div class="popup-actions-active justify-center">
        ...
        <button type="button" class="btn btn-active" id="gscgff-popup-active-free">
            <?php echo esc_html__('Cancel', 'gsheetconnector-gravity-forms'); ?>
        </button>
