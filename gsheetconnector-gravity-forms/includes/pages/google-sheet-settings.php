...
<div class="gsheet-header">
    ...
    <h1 class="gsheet-logo-text"><span><?php echo esc_html( __('Gravity Forms - GSheetConnector', 'gsheetconnector-gravityforms' ) ); ?></span> <small><?php echo esc_html( __('Version', 'gsheetconnector-gravityforms' ) ); ?> : <?php  echo esc_html($plugin_version, GRAVITY_GOOGLESHEET_VERSION); ?> </small></h1>
