                        ...
                        <div class="card-wp" id="gscgff-googlesheet">
                            <div class="inside">
                                <div class="heading mt-0">
                                    <?php echo esc_html(__('Google Account Connection', 'gsheetconnector-gravity-forms')); ?>
                                    <span
                                        class="badge"><?php echo esc_html(__('Auto Setup', 'gsheetconnector-gravity-forms')); ?></span>
                                </div>

                                <p><?php echo esc_html(__('Sign in with your Google account to connect Gravity Forms with Google Sheets. Once connected, your data syncs based on your settings. Learn more in the documentation', 'gsheetconnector-gravity-forms')); ?>
...
<div id="gscgff-confirm-deactive-popup-free" class="gscgff-popup-overlay d-none">
    <div class="gscgff-popup text-center">
        ...
        <div class="popup-actions d-flex justify-center gap-10">
            <button type="button" class="btn deactivate-btn" id="gscgff-deactive-popup-free-cancel">
